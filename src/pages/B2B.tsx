...
const b2bServices = [
  {
    ...
    image: {
      src: "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?crop=entropy&cs=tinysrgb&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxyZXNlYXJjaCUyMGFuYWx5c2lzfGVufDB8fHx8MTc2MjI0NzU0OHww&ixlib=rb-4.0.3&q=80&w=1080&h=200",
...
export default function B2BPage() {
  return (
    <>
      ...
      >
        <div className="absolute inset-0 bg-blue-200/90" />
        <div className="container mx-auto px-4 relative z-10 text-primary">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            {stats.map(stat => (
              <div key={stat.label} className="p-6 bg-black/10 rounded-lg">
                ...
                <p className="text-base md:text-lg text-primary/80 mt-2">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
