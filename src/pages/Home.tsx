      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {newServices.map((service, index) => (
              <div key={index} className="flex flex-col items-center text-center p-6 bg-card rounded-lg shadow-md transition-shadow duration-300 hover:shadow-xl">
                <div className="relative h-20 w-20 mb-4">
                  <img src={service.icon} alt={service.name} className="object-contain w-full h-full" loading="eager"/>
                </div>
           ...
           <div className="mt-12">
    <Link to="https://www.nexstar.host" target="_blank" rel="noopener noreferrer">
