  ...
  return (
    <>
       <div className="flex flex-col md:flex-row w-full">
        <section className="relative h-[60vh] md:h-[91vh] w-full md:w-[70%] bg-black">
          <Carousel
            plugins={[
              Autoplay({
                delay: 2000,
        ...
        <div className="relative w-full md:w-[25%] h-[91vh] md:h-[91vh] border border-gray-300 rounded-lg overflow-hidden my-4 md:my-0">
          <video 
