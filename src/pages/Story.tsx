          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
             ...
             <div className="animate-in fade-in slide-in-from-right-10 duration-700 flex justify-center">
                <div className="relative aspect-square w-full max-w-xs rounded-lg overflow-hidden">
                    <img src="https://ik.imagekit.io/ggelm1lwa/nexstar-logo-removebg-preview.png?updatedAt=1759921791444"
                      alt="Nexstar Logo"
               ...
               <div key={index} className={`mb-8 flex justify-between items-center w-full ${index % 2 === 0 ? "flex-row-reverse left-timeline" : "right-timeline"}`}>
                ...
                <div className="order-1 bg-card/80 backdrop-blur-sm rounded-xl shadow-xl w-5/12 max-w-sm overflow-hidden animate-in fade-in zoom-in-90 duration-500">
                  <div className="relative w-full h-48">
                    <img src={event.image.src} alt={event.title} className="w-full h-full object-p-2" data-ai-hint={event.image.hint}  />
                  </div>
                  <div className="p-6">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            {coreValues.map((value, index) => (
               <Card key={index} className="group relative overflow-hidden bg-card/80 backdrop-blur-sm border-border/50 animate-in fade-in slide-in-from-bottom-5 duration-500" style={{animationDelay: '${index * 150}ms'}}>
                  <img src={value.image.src} alt={value.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" data-ai-hint={value.image.hint}  />
