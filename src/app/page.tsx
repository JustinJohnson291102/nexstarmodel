       ...
       <div className="flex flex-col w-full">
         <section className="relative h-auto md:h-[91vh] w-full flex items-center justify-center bg-background">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-center p-4 w-full h-full">
              ...
              <div className="flex justify-center items-center">
                 <Image src="https://ik.imagekit.io/ggelm1lwa/office%20hero%20banner.jpeg?updatedAt=1759561798226" alt="Office hero banner" width={600} height={700} className="object-cover rounded-lg shadow-lg mb-2" data-ai-hint="office banner" />
              </div>
            </div>
          </section>
        </div>
